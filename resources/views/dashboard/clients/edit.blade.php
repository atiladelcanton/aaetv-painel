    ...
    <div class="row clearfix">
        <div class="col-lg-12 col-md-12">
            <div class="card planned_task">
                <div class="body">
                    <form action="{{ route('clientes.alterar',$client->id) }}" method="post" id="frm_cadastro">
                        {{ @csrf_field() }}
                        <div class="row">
                            <div class="col-md-2">
                                <label for="app" class="control-label">APP</label>
                                <select name="app" class="form-control selectize @error('app') 'has-error' @enderror"
                                        required>
                                    <option value="">-- Selecione --</option>
                                    @foreach($players as $player)
                                        <option
                                            value="{{$player}}" {{$client->app == $player ? 'selected':''}}>{{$player}}</option>
                                    @endforeach
                                </select>
                                @error('app')
                                <code>{{ $message }}</code>
                            ...
                            @dd($client->method_payment)
                            <div class="col-md-2">
                                <label for="method_payment" class="control-label">Forma Pagamento</label>
                                <select name="method_payment"
                                        class="form-control selectize @error('method_payment') 'has-error' @enderror"
                                        required>
                                    <option value="">-- Selecione --</option>
                                    <option value="Boleto" {{$client->method_payment =='Boleto' ? 'selected':''}}>
                                        Boleto
                                    </option>
                                    <option
                                        value="Transferência" {{$client->method_payment =='Transferencia' ? 'selected':''}}>
                                        Transferência
                                    </option>
                                </select>
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="monthly_payment" id="monthly_payment" class="form-control"
                                       required value="{{$client->monthly_payment}}">
                                @error('method_payment')
                                <code>{{ $message }}</code>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group  @error('code_ssiptv') 'has-error' @enderror">
                                    ...
                                    <input type="text" name="code_ssiptv" id="code_ssiptv" class="form-control"
                                           placeholder="5HDE" value="{{$client->code_ssiptv}}">
                                    @error('code_ssiptv')
                                    <code>{{ $message }}</code>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group  @error('code_duplex') 'has-error' @enderror">
                                    ...
                                    <input type="text" name="code_duplex" id="code_duplex" class="form-control"
                                           placeholder="99:99:99:99:9b:99 / 99999" value="{{$client->code_duplex}}">
                                    @error('code_ssiptv')
                                    <code>{{ $message }}</code>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group  @error('email_smart_up') 'has-error' @enderror">
                                    ...
                                    <input type="text" name="email_smart_up" id="email_smart_up" class="form-control"
                                           placeholder="emai@email.com / senha" value="{{$client->code_duplex}}">
                                    @error('code_ssiptv')
                                    <code>{{ $message }}</code>
                                    @enderror
                                </div>
