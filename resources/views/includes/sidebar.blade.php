<div id="left-sidebar" class="sidebar mini_sidebar_on">
    <div class="navbar-brand">
        <a href="{{url('/')}}" class="logo"><img src="{{asset('img/logo.jpeg')}}" alt="{{env('APP_NAME')}}" style="width: 40px;">
        <span style="font-weight: bold; font-size: 21px;"><span style="color:#008ED0; font-size: 21px;">AAE</span>TV</span>
        </a>
